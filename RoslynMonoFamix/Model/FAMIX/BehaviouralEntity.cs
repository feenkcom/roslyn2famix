...
namespace FAMIX
{
  ...
  public class BehaviouralEntity : FAMIX.ContainerEntity
  {
    ...
    private List<FAMIX.BehaviouralEntity> clientBehaviours = new List<FAMIX.BehaviouralEntity>();
    
    [FameProperty(Name = "clientBehaviours")]    
    public List <FAMIX.BehaviouralEntity> ClientBehaviours
    {
      get { return clientBehaviours; }
      set { clientBehaviours = value; }
    }
    public void AddClientBehaviour(FAMIX.BehaviouralEntity one)
    {
    ...
    private List<FAMIX.BehaviouralEntity> providerBehaviours = new List<FAMIX.BehaviouralEntity>();
    
    [FameProperty(Name = "providerBehaviours")]    
    public List <FAMIX.BehaviouralEntity> ProviderBehaviours
    {
      get { return providerBehaviours; }
      set { providerBehaviours = value; }
    }
    public void AddProviderBehaviour(FAMIX.BehaviouralEntity one)
    {
